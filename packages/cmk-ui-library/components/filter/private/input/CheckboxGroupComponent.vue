...
<template>
  <fieldset class="cmk-checkbox-group-component">
    <CmkLabel v-if="component.label" variant="subtitle">
      {{ component.label }}
    </CmkLabel>
    <div class="cmk-checkbox-group-component__items">
      <CheckboxComponent
...
<style scoped>
.cmk-checkbox-group-component {
  border: none;
  padding: 0;
  margin: 0;
}

.cmk-checkbox-group-component__items {
  display: flex;
  flex-wrap: wrap;
  align-items: center;
  gap: var(--dimension-6);
