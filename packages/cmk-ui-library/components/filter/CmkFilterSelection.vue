...
import type { FlatFilter } from './private/selection/types'
import {
  type CategoryDefinition,
  type FilterGroup,
  buildProcessedCategories
} from './private/selection/utils'
import type { FilterType } from './types.ts'
import { useFilterGroups } from './useFilterDefinitions.ts'
...
<template>
  <div class="cmk-filter-selection__main-container">
    <template v-if="processedCategory">
      <div class="filter-menu__sticky-header">
        ...
        <FilterSelectionSearch
          ...
          class="cmk-filter-selection__search-container"
...
<style scoped>
.cmk-filter-selection__main-container {
  display: flex;
  flex-direction: column;
}

.cmk-filter-selection__scroll-container {
  min-height: 0;
...
.cmk-filter-selection__search-container {
  position: relative;
