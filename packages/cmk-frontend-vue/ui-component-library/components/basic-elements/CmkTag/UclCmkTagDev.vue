...
<template>
  ...
  <div class="ucl-cmk-tag-dev__matrix-container">
    <table class="ucl-cmk-tag-dev__tag-matrix">
      <thead>
        <tr>
          <th>Color / Variant</th>
          <th>Fill</th>
...
.ucl-cmk-tag-dev__matrix-container {
  margin: 20px 0;
}

.ucl-cmk-tag-dev__tag-matrix {
...
.ucl-cmk-tag-dev__tag-matrix th,
.ucl-cmk-tag-dev__tag-matrix td {
...
.ucl-cmk-tag-dev__color-label {
  font-weight: 600;
  background-color: var(--ux-theme-3);
  text-align: left;
}

.ucl-cmk-tag-dev__tag-matrix tr:nth-child(even) {
  background-color: var(--ux-theme-4);
}

.ucl-cmk-tag-dev__tag-matrix tr:hover {
